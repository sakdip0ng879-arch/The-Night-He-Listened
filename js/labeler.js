...
TK.labeler = (function(){
  ...
  function layout(places, vb, screenW, opts){
    ...
    for (const [id,p] of shown){
      ...
      /* ป้ายกำลังพลใช้จำนวนเต็ม จึงลองระยะสำรองอีกวงเฉพาะชื่อที่ฉากบังคับแสดง
         ใช้เมื่อสามวงเดิมเต็มแล้วเท่านั้น แทนการยอมให้ชื่อชนป้ายจำนวนคน */
      const SPREADS = force.has(id) ? [1, 1.6, 2.4, 3.2] : [1];
