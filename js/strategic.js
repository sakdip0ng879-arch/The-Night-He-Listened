...
TK.map = (function(){
  ...
  /* ★★★ สองระดับ ไม่ใช่สามแล้ว (2026-09-10) — เจ้าของสั่ง: *"พอซูมเข้าไปต้องเห็น
     รายละเอียดอื่นๆ ทุกอันได้แล้ว ไม่งั้นแผนที่มันจะโล้นมากๆ เลย คนอ่านจะได้เห็น
     ความ Abundant ของแต่ละพื้นที่"*

     ของเดิมมีชั้นกลาง `region` (700–1100) ที่ตัด `town` ทิ้งทั้ง 38 จุด —
     ★ และนั่นคือ **ช่วงที่คนเลื่อนดูมากที่สุด** (กล้องของฉากอยู่ที่ 650–860)
     ผลคือพอถอยจาก 690 ไป 710 เมืองหายไปเป็นสิบจุดพร้อมกันโดยไม่มีเหตุผลที่ผู้อ่านเห็น
     ...
     เพดานสองอันนั้นทำงานตามพื้นที่จริงบนจอ ซึ่งแม่นกว่าการตัดตามชนิดแบบเหมารวม
     ⇒ เหลือกติกาเดียว: **ภาพรวม = เฉพาะเมืองที่เลือกไว้ · นอกนั้น = ครบ** */
  ...
  function placeAtZoom(id,p){
    ...
    return true;                       /* region + local — ปล่อยครบทุกจุดในข้อมูล */
  }
  const SYM_RANK = {
