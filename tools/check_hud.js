...
const SHARE_OK = {
  ...
  /* ⚠ ข้อความเดิมเขียนว่า "หลิวเป้ยยกทัพขึ้นฮั่นจงด้วยตัวเอง" — ไม่จริงแล้วตั้งแต่ 2026-09-13
     เจ้าของเคาะให้ **จ้าวหยุน** นำทัพหลวง เพราะ c1-08 หลิวเป้ยยังอยู่เฉิงตูรับจางเฟย (LOG §5.34) */
  "c1-06": "ราชโองการฉบับแรกของรัชกาล — ทัพหลวงขึ้นฮั่นจงโดยมีจ้าวหยุนเป็นแม่ทัพ (หลิวเป้ยอยู่เฉิงตู) " +
           "· นี่คือ 'การทุ่มสุดตัวครั้งเดียว' ที่กติกาข้อนี้เจาะช่องไว้ให้ " +
